...
import { useCreateFoundItemMutation } from '@/redux/foundItemApi';
...
function FoundItemPage() {
  ...
  const [crateLostItem, { isLoading: lostItemL }] =
      ...
      <form className="flex flex-col mt-8" onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-6 flex flex-col items-end gap-4 md:flex-row">
          ...
          <div className="w-full">
            ...
            {errors.foundDate && (
              <p className="text-red-400 mt-1">
                {errors.foundDate.message as string}
              </p>
            )}
          </div>
        </div>

...
const Navbar = () => {
  ...
  return (
    <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8 bg-white/40 rounded-b-lg shadow-md ">
        ...
        <ul className="flex items-center hidden space-x-8 lg:flex">
          <li>
            <Link
              ...
              title="Our product"
              className="font-semibold tracking-wide text-green-500 transition-colors duration-200 hover:text-deep-purple-accent-400">
              HOME
            </Link>
          </li>
          <li>
